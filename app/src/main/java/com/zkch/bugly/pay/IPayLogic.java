...
import com.zkch.bugly.constant.Constant;
...
public class IPayLogic {
    ...
    public String WXPay(Order order) {
        ...
        String result = HttpKit.get(Constant.WXPAY_URL, queryParas);
        return result;
    }
    ...
    public String getAliPayOrderInfo(Order order) {
        String result = HttpKit.get(Constant.ALIPAY_URL);
        return result;
    }
    ...
    public String getUPPayOrderInfo(Order order) {
        String result = HttpKit.get(Constant.UPPAY_URL);
        return result;
    }
